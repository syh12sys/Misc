...
from controlnet_util import get_pose_image, get_depth_map, get_canny_image
...
from utils import download_file, clean_files
...
SDXL_NAME_TO_PATHLIKE = {
    ...
    "stable-diffusion-xl-base-1.0": {
        ...
        "path": "cog/checkpoints/models--stabilityai--stable-diffusion-xl-base-1.0",
    },
    "afrodite-xl-v2": {
        ...
        "path": "cog/checkpoints/models--stablediffusionapi--afrodite-xl-v2",
    },
    "albedobase-xl-20": {
        ...
        "path": "cog/checkpoints/models--stablediffusionapi--albedobase-xl-20",
    },
    "albedobase-xl-v13": {
        ...
        "path": "cog/checkpoints/models--stablediffusionapi--albedobase-xl-v13",
    },
    "animagine-xl-30": {
        ...
        "path": "cog/checkpoints/models--stablediffusionapi--animagine-xl-30",
    },
    "anime-art-diffusion-xl": {
        ...
        "path": "cog/checkpoints/models--stablediffusionapi--anime-art-diffusion-xl",
    },
    "anime-illust-diffusion-xl": {
        ...
        "path": "cog/checkpoints/models--stablediffusionapi--anime-illust-diffusion-xl",
    },
    "dreamshaper-xl": {
        ...
        "path": "cog/checkpoints/models--stablediffusionapi--dreamshaper-xl",
    },
    "dynavision-xl-v0610": {
        ...
        "path": "cog/checkpoints/models--stablediffusionapi--dynavision-xl-v0610",
    },
    "guofeng4-xl": {
        ...
        "path": "cog/checkpoints/models--stablediffusionapi--guofeng4-xl",
    },
    "juggernaut-xl-v8": {
        ...
        "path": "cog/checkpoints/models--stablediffusionapi--juggernaut-xl-v8",
    },
    "nightvision-xl-0791": {
        ...
        "path": "cog/checkpoints/models--stablediffusionapi--nightvision-xl-0791",
    },
    "omnigen-xl": {
        ...
        "path": "cog/checkpoints/models--stablediffusionapi--omnigen-xl",
    },
    "pony-diffusion-v6-xl": {
        ...
        "path": "cog/checkpoints/models--stablediffusionapi--pony-diffusion-v6-xl",
    },
    "protovision-xl-high-fidel": {
        ...
        "path": "cog/checkpoints/models--stablediffusionapi--protovision-xl-high-fidel",
    },
    "RealVisXL_V3.0_Turbo": {
        ...
        "path": "cog/checkpoints/models--SG161222--RealVisXL_V3.0_Turbo",
    },
    "RealVisXL_V4.0_Lightning": {
        ...
        "path": "cog/checkpoints/models--SG161222--RealVisXL_V4.0_Lightning",
    },
}
...
class Predictor(BasePredictor):
    ...
    def setup_lazy(self):
        ...
        self.face_adapter = f"./cog/checkpoints/ip-adapter.bin"
        controlnet_path = f"./cog/checkpoints/ControlNetModel"
        ...
        self.load_weights(self.base_weights)
    ...
    def setup_lcm_lora(self):
        ...
        lcm_lora_path = f"cog/checkpoints/{lcm_lora_key}"
    ...
    def setup_extra_controlnets(self):
        ...
        for controlnet_key in [
            ...
            controlnet_path = f"cog/checkpoints/{controlnet_key}"
    ...
    def predict(
        self,
        image: str = Input(
            description="Input face image url",
        ),
        pose_image: str = Input(
            description="(Optional) reference pose image url",
            default=None,
        ),
        prompt: str = Input(
        ...
        # download image
        if image is None:
            raise Exception("image url is none")
        face_image_file = download_file(image)
        if face_image_file is None:
            raise Exception("download face image error")

        pose_image_file = None
        if pose_image is not None:
            pose_image_file = download_file(pose_image)
            if pose_image_file is None:
                raise Exception("download pose image error")

        # Generate
        images = self.generate_image(
            face_image_path=str(face_image_file),
            pose_image_path=str(pose_image_file) if pose_image else None,
            prompt=prompt,
            negative_prompt=negative_prompt,
